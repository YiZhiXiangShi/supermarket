      ...
      <el-pagination
        ...
        <el-dialog title="编辑" :visible.sync="dialogFormVisible">
          <el-form label-width="80px">
            ...
            <el-form-item label="科室名称"><el-input v-model="pojo.name" /></el-form-item>
            <el-form-item label="科室编号"><el-input v-model="pojo.number" /></el-form-item>
   ...
   import moment from 'moment'
     ...
     pageData(page){
      ...
      handleEdit(id){
            ...
            if(this.id!==''){
              //根据id查询数据绑定到模型上面
               departmentApi.find(this.id).then(response=>{
         ...
         if(this.id===null||this.id===''){
            ...
            //新增操作
            departmentApi.update(this.pojo).then(response=>{
      ...
      handleDelete(id){
       this.$confirm('此操作将永久删除该科室, 是否继续?', '提示', {
          ...
          departmentApi.delete(id).then(response=>{
